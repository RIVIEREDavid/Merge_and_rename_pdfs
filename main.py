...
class ListBoxWidget(QListWidget):
    def __init__(self, merge_button, split_button, file_paths):
        super().__init__()
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.list_widget = ListBoxWidget(self.merge_button, self.split_button, self.file_paths)  # passer en paramètres merge_button et split_button
